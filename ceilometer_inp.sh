...
watch -n 1 "ceilometer --os-username admin --os-password admin_pass --os-project-id 2448c5574f994284a0de2604962a55a0 --os-domain-name default --os-auth-url 192.168.31.2/v3/  sample-list --meter cpu_util >> cpu_util.txt"